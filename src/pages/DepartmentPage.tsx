...
import { useCreateDepartment, useDepartments, useDeleteDepartment } from "../api/departments.queries"; 
            ...
            <main className="mx-auto max-w-5xl px-4 py-6 space-y-4"> 
                <form onSubmit={onCreate} className="rounded-xl border bg-white p-4 space-y-3"> 
                    <p className="text-sm text-slate-600"> 
                        <b>Mutation (POST)</b>: crea departments y luego invalida cache para refrescar listado. 
                    </p> 
                                    ...
                                    <tr key={c.id} className="border-t"> 
                                        ...
                                        <td className="p-3"> 
                                            <button 
                                                ...
                                                onClick={() => { 
                                                    if (!confirm("¿Seguro que deseas borrar este departments?")) return; 
